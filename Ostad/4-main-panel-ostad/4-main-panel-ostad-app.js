...
{
    const deta =  await (await fetch(`/posts/${postId}/comments`)).json();
...
function match(d)
{
    ...
    document.getElementById('lastname').textContent        = d.lastName
    document.getElementById('Id').textContent              = d.lastName
    document.getElementById('group').textContent           = d.lastName
    document.getElementById('shomare_hesab').textContent   = d.lastName
    document.getElementById('shomare_shaba').textContent   = d.lastName
    document.getElementById('email').textContent           = d.lastName
    document.getElementById('phoneNum').textContent        = d.lastName
    document.getElementById('daftar_shomareh').textContent = d.lastName
}
